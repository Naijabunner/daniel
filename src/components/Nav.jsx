const Navbar = () => {
    return (
    <nav className="tran_one absolute z-50 top-5 flex justify-between px-5  w-screen items-center"> 
...
<div className="logo flex h-10 items-center">
    <p><span className="  p-1 text-center mr-1 rounded-full base_color">🔆</span>someText</p>
</div>
